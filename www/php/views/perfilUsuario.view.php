...
<div class="pagina">
    <div class="elementos">
        <div class="bloque">
            <aside>
                <a href="/perfilUsuario/info" class="link"">
                    <div class=" enlaces">
                    <div class="cliente">
        ...
        <a href="#" class="link">
            <div class="enlaces">
                <div class="buzon">
                    <svg width="32px" height="32px" viewBox="3 5 40 38" fill="none" xmlns="http://www.w3.org/2000/svg" display="flex">
                        <path d="M35 18s-8.63 8-11 8c-2.37 0-11-8-11-8M34.04 31l-6.5-6.5M20.54 24.5l-6.5 6.5" stroke="#253238" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        </path>
                        <path d="M9.04 23.5c0-.748-.011-1.45-.022-2.112-.021-1.325-.04-2.495.039-3.578.116-1.59.436-2.774 1.153-3.692.712-.911 1.925-1.7 4.12-2.257C16.531 11.3 19.632 11 24 11s7.468.302 9.67.86c2.195.558 3.408 1.347 4.12 2.258.717.918 1.038 2.102 1.153 3.692.079 1.083.06 2.253.039 3.578-.01.662-.022 1.364-.022 2.112 0 .412.002.814.003 1.206.008 1.708.014 3.229-.13 4.61-.174 1.678-.563 3.017-1.356 4.085C35.903 35.517 32.388 37 24 37s-11.903-1.483-13.476-3.6c-.794-1.067-1.183-2.406-1.358-4.085-.143-1.38-.137-2.9-.13-4.609.002-.392.004-.794.004-1.206Z" stroke="#253238" stroke-width="2"></path>
                    </svg>
                    <p>Buz&oacute;n</p>
                </div>
